...
uv run pytest tests/unit/test_route_scorer.py tests/integration/test_route_analyze_cli.py tests/integration/test_route_explain_cli.py tests/integration/test_mcp_tools.py tests/integration/test_ledger_cli.py tests/security/test_ledger_redaction.py
uv run pytest
uv run ruff check .
```
